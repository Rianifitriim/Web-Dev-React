    ...
    <div className="container mx-auto px-5">
      <div className="grid grid-cols-1 lg:grid-cols-6">
        ...
        <div className="hidden lg:block lg:col-span-3 my-16 mx-auto">
          <h1
          className="text-center text-white lg:mx-40 text-lg font-bold">
          Lets Get Started!
          </h1>
          <SignUpIcon />
        </div>
            ...
            <form className=" w-full mx-auto">
              ...
              <div>
                ...
                <input type="text" name="name"
                  ...
                  value={values.name} onChange={handleChange} placeholder="Enter Your Name"></input>
              ...
              <div className="mt-3">
                ...
                <input type="email" name="email"
                  className="input text-xs w-full p-2 border border-gray-300 rounded mt-1 hover:border-blue-600"
                  value={values.email} onChange={handleChange} placeholder="Enter Your Email"></input>
                <div className="text-xs text-red-600	">
              ...
              <div className="mt-4">
                ...
                <input type="password" name="password"
                  className=" input text-xs w-full p-2 border border-gray-300 rounded mt-1 hover:border-blue-600"
                  value={values.password} onChange={handleChange} placeholder="Enter Your Password"></input>
              ...
              <div className="mt-4">
                ...
                <input type="password" name="confirmPassword"
                  ...
                  placeholder="Enter Your Confirm Password"></input>                <div className="text-xs text-red-600	">
