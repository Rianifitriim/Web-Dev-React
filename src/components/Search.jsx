...
export default function Search(){
  return (
    <>
      ...
      type="text"
      placeholder="Search"
      className="py-1 placeholder-gray-900 text-gray-900 relative bg-white text-base outline-none focus:outline-none focus:ring w-full pl-5 filter drop-shadow-3xl rounded-full"/>
      <span
