...
export const ButtonType = {
  ...
  navLogin : "bg-3F70F9 text-white hover:border-blue-500 hover:bg-blue-400 w-full sm:w-24 rounded-full", 
  ...
  detailCheckout : "bg-3F70F9 text-white hover:border-blue-500 hover:bg-blue-400 w-full sm:w-1/2 rounded-full",
  // untuk button checkout page cart 
  cartCheckout : "bg-3F70F9 text-white hover:border-blue-500 hover:bg-blue-400 w-1/2 sm:w-32 rounded-full", 
  // untuk button remove & remove all page cart
  cartRemove : "bg-transparent text-3F70F9 border border-3F70F9 hover:bg-blue-100 w-1/2 sm:w-32 rounded-full", 
}
